export const disciplina = [
  ...
  {
    title:"Inglês VI",
    ementa: "Aprimoramento da compreensão e produção oral e escrita por meio da integração das habilidades linguístico-comunicativas. Ênfase na oralidade, atendendo às especificidades acadêmico-profissionais da área e abordando aspectos socioculturais da língua inglesa.",
    dia: "Guns 'n Roses",
    horario: 1992
  },
  {
  ...
  },
  {
  ...
  },
   {
    ...
    ementa: "Elaboração de portfólios e técnicas profissionais de aprese",
    dia: "Guns 'n Roses",
    horario: 1992
  }
]